...
export default function JourneySection() {
  ...
  return (
    <section 
      ref={ref}
      className="mt-16 p-8 bg-gradient-to-br from-[#F8FAFC] to-[#F8FAFC] rounded-xl shadow-2xl relative overflow-hidden"
    >
      {/* Decorative elements */}
      ...
      <div className="relative z-10">
        ...
        <div className="grid md:grid-cols-4 gap-8 text-center">
          {[
            ...
            { value: counts.trips, label: "Successful Trips", icon: "🛣️" }
          ].map((stat, index) => (
            <motion.div
              key={index}
